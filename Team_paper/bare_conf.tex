...
For creating a state machine, we use SMACH \cite{smach} package that is "a task-level architecture for rapidly creating complex robot behavior" and it is even ROS-independent. 
